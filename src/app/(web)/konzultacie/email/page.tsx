...
export default function EmailKonzultaciaPage() {
  return (
    <div className="bg-red-50 py-8 px-4 flex-grow">
      <section className="p-4 md:p-12 container mx-auto">
        <h1 className="pb-12 text-6xl text-center font-semibold">Emailová konzultácia záznamu</h1>
        <div className="bg-white p-12 shadow-md flex flex-wrap md:flex-nowrap">
          ...
          <div id="right-side mt-6 md:mt-12">
            <div className="prose mt-6 md:mt-0">
              <p>
                <strong>Nie si si istá vlastným vyhodnotením cyklu?</strong> Vždy je dobré sa vo svojom zázname uistiť,
                preto neváhaj využiť spoluprácu so mnou.
              </p>
              <p>
